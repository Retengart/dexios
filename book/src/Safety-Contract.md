...
metadata, verification commands, and optional asset SHA256 hashes. It does not
claim bit-for-bit reproducibility, signing trust, SBOM completeness, SBOM
protection, supply-chain prevention, or any safety property not covered by the
recorded checks.
