...
| KEY-001 | Deleting the final usable keyslot can create an encrypted artifact with no usable keyslots. | Current source analysis in `dexios-domain/src/key/delete.rs`; `dexios-domain/tests/keyslots_v1.rs::quarantined_known_bug_key_del_rejects_final_keyslot`. | Phase 5 |
